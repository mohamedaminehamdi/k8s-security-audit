...
import (
	...
	"github.com/mohamedaminehamdi/kubepilot/internal/client"
)

const (
	EnvkubepilotToken = "kubepilot_TOKEN"
	EnvkubepilotLang  = "kubepilot_LANG"
)
...
func (o *Options) Complete() error {
	o.Token = os.Getenv(EnvkubepilotToken)
	if len(o.Token) == 0 {
		return fmt.Errorf("please specify the api token with ENV %s", EnvkubepilotToken)
	}
	o.Lang = getEnvOrDefault(EnvkubepilotLang, "English")
	return nil
}
